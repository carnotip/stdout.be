...
I disagree, and I think it's a messy discussion. I see four basic talking points that we should really disentangle.h3. First talking point: stumbling blocks
...
We need more of them, but app makers have a pretty big toolkit already.h3. Second talking point: plug 'n play
...
But, again, we should separate "apps don't work" from _this_ particular discussion.h3. Fourth talking point: software architecture
