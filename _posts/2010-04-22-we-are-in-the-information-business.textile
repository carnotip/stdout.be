...
Let's not kid ourselves. A new way of doing journalism requires new technology to support and foster that innovation. That technology should reach right into the core of our journalistic endeavors, not just touch the periphery like yet another infographic or mashup.h2. Why would we want structure?
...
How to get started, though? Daniel's advice to "gather enough information" is rather vague as a guideline. Here's what you do: model the problem domain.h3. Model the problem domain
...
Presentation is a designer's job, and it doesn't concern journalists or editors. It shouldn't be a part of content entry. How you want to mark things up for display might change. It probably will. But _what something is_ won't change. So avoid markup, and _think_  _ "structure":http://blog.programmableweb.com/2009/11/11/content-portability-building-an-api-is-not-enough/ _ instead.

We should be able to generate HTML or any other markup on the fly, based on how a text is structured. That means we need domain-specific ways of indicating, err, _marking up_ a text. We need to start creating our own little "Markdown":http://daringfireball.net/projects/markdown/ -like languages for journalism.

[caption id="attachment_136" align="alignnone" width="411" caption="WYSIWYG is all about getting your writing to look like you want it to"] " !http://stdout.be/wp-content/uploads/2010/04/wysiwyg.png! ":http://stdout.be/wp-content/uploads/2010/04/wysiwyg.png [/caption]

[caption id="attachment_137" align="alignnone" width="389" caption="WYSIWYM is all about showing what your content actually is"] " !http://stdout.be/wp-content/uploads/2010/04/wysiwym.png! ":http://stdout.be/wp-content/uploads/2010/04/wysiwym.png [/caption]h3. What is structure, anyway?
...
Thinking in terms of relationships and entities pays for itself many times over, but don't underestimate the challenge in doing it right.h2. How do we get there?
...
[caption id="attachment_138" align="alignnone" width="520" caption="Custom fields in Wordpress aren't particularly versatile, but they still make it possible to add a bit of structure to your content"] " !http://stdout.be/wp-content/uploads/2010/04/wp-custom-fields.png! ":http://stdout.be/wp-content/uploads/2010/04/wp-custom-fields.png [/caption]

[caption id="attachment_139" align="alignnone" width="520" caption="Custom fields, using the Content Construction Kit in Drupal. More versatile than Wordpress, but still difficult to specify more involved connections between entities. Nodereferences in CCK allow for references like"this photograph belongs to this article"but they don't allow you to enrichen that reference any further. For example, it would be tricky to specify not only that Ringo belongs to the Beatles, but also that he joined in 1962 and that he was the drummer in the band."] " !http://stdout.be/wp-content/uploads/2010/04/drupal-cck.png! ":http://stdout.be/wp-content/uploads/2010/04/drupal-cck.png [/caption]h2. Peace of mind is like a piece of heaven
