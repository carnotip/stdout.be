...
Take, for example, how you access your database in Drupal. You use the Views module. It's incredibly flexible. It also means that instead of writing a simple line of Django ORM code like[gist id="317065"]and processing that in your view with

[gist id="317066"]

you get to fill out a gigantic form that generates your view, after which you'll have to fill out a similarly large form in the Panels module to get that list displayed where you want it to. And if want to customize the html that Views produces (because, being geared towards end-users, Views is both a query builder and an html generator) you'll have to override a bunch of theme files as well.[caption id="attachment_25" align="alignleft" width="500" caption="Could you give me the latest comments?"—"Sure, just fill in this small form, file it in triplicate, and we'll get back to you.""] " !http://stdout.be/wp-content/uploads/2010/02/Screen-shot-2010-02-13-at-16.33.35-1024x672.png! ":http://stdout.be/wp-content/uploads/2010/02/Screen-shot-2010-02-13-at-16.33.35.png [/caption]h3. Easier for them is harder for me
...
Frameworks should enable you to get to the cool stuff quicker, not after you've worked around a bunch of default behavior that is sensible for a plain CMS but not so much for "the kind of websites people have come to expect":http://www.slideshare.net/simon/cowboy-development-with-django/87 in 2010.h3. Documentation
